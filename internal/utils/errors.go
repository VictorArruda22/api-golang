...
var (
	...
	ErrCategoryRepositoryNotFound      = errors.New("repository: Category not found")
	ErrCategoryRepositoryRequest       = errors.New("repository: Request Category is wrong")
	ErrCategoryRepositoryInternalError = errors.New("repository: Internal error")
	ErrCategoryRepositoryInvalidID     = errors.New("repository: Invalid id")
)
